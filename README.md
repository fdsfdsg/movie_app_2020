### create-react-app으로 yts.ag 영화정보api를 이용한 영화목록순위
***
...
***
1/23 css부분만 남았다. 그리고 github 에 static 파일들을 공짜로 호스팅해주는 기능이 있대서 추가할 예정이다. 

그리고 지금까진 구버전 리액트였는데 2019년버전 웹서비스만들기를 찾았다. 그걸로 복습할 예정이다.
